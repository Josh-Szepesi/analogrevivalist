---
layout: post
title: "Reel-to-reel tape sources: where to buy and what to look for"
...
## Evaluating Modern Reel-to-Reel Tape Sources
...
## Technical Specifications: Bias, Thickness, and Backcoating
...
Backcoating is a dark, matte layer on the non-magnetic side of the tape. It was designed to improve winding evenness and reduce static. While backcoating was a major advancement, it is also the primary site of Sticky Shed Syndrome in vintage tapes. Modern tapes like RTM LPR35 use a stable backcoating that provides the benefits of smooth winding without the risk of hydrolysis. According to [technical specifications from Recording The Masters](https://www.recordingthemasters.com/technical-specifications/), modern backcoating also significantly reduces "wow and flutter" by providing a more consistent grip on the capstan and pinch roller.

## Avoiding Common Pitfalls and Tape Problems
...
## Step-by-Step Guide to Inspecting a Used Reel
...
1.  **The Smell Test:** Open the box and take a deep breath. A healthy tape should have a very faint "crayony" smell or no smell at all. If you detect a sharp, pungent vinegar odor or a musty, earthy smell (mold), do not put it on your machine.
2.  **The Visual Pack Inspection:** Look at the side of the tape pack. It should be one solid color (usually dark brown or black). If you see white spots, that is mold. If the tape looks wavy (cupping) or the edges are ruffled (cinching), the tape has been physically damaged by a poorly aligned machine and will likely have significant signal dropouts.
3.  **The Manual Pull Test:** Pull about two feet of tape off the reel. Hold it between your thumb and forefinger and gently slide your fingers along the length. It should feel smooth. If your fingers feel a tacky resistance, or if dark brown dust immediately coats your skin, the tape is shedding.
4.  **The "Slow Wind" Test:** Thread the tape onto your deck but do not play it. Use the manual "library wind" or a slow fast-forward to move the tape. Watch the stationary guides. If you see any residue building up or hear a high-pitched squeal, stop the machine immediately. This tape requires "baking" (a temporary professional heat treatment) before it can be played safely.
5.  **The Leader Check:** Check if the tape has proper leader tape (colored plastic at the ends). If the magnetic tape is taped directly to the hub with old adhesive, that glue has likely migrated into the first few layers of the reel, making them unusable. You will need to cut away the contaminated section and splice on new leader tape.

## Comparison of Tape Formulations
...
## FAQ: Frequently Asked Questions About Reel Tape

### Can I "bake" a sticky tape to save the recording?
...
### Does the color of the oxide tell me anything about the quality?
...
### Is it safe to reuse old tapes for new recordings?
...
### Related Reading
- [How to set up and calibrate a vintage reel to reel deck](/2026/05/13/2026-05-13-how-to-set-up-and-calibrate-a-vintage-reel-to-reel-deck/)
