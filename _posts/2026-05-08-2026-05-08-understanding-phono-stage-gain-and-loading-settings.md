---
layout: post
title: "Understanding phono stage gain and loading settings"
description: "Master phono stage gain and loading settings to unlock the full potential of your vinyl setup. Learn how to match cartridges with vintage and modern preamps."
date: 2026-05-08
image: /assets/images/2026-05-08-understanding-phono-stage-gain-and-loading-settings-hero.jpg
---
...
![Understanding phono stage gain and loading settings hero image](/assets/images/2026-05-08-understanding-phono-stage-gain-and-loading-settings-hero.jpg)
...
To manage this, you need a phono stage that allows you to adjust the input capacitance. The [Pro-Ject Phono Box DC](https://www.amazon.com/dp/B007DB5I60) is a solid entry point, but more advanced units allow you to toggle between 0pF, 100pF, and 220pF. If you are using high quality, low capacitance cables, you might need to add capacitance at the preamp to hit the manufacturer's spec. If you are using generic long cables, you should set your preamp to the lowest possible setting. You can find technical charts for most cartridges on sites like [Ortofon's support page](https://www.ortofon.com/support/support-hifi/cartridge-sensitivity-and-output-voltage/) which will tell you exactly what the engineers intended for that specific stylus.
...
1.  **Identify your cartridge specifications:** Look up the "Output Voltage" and "Recommended Load" in your cartridge manual. This is your baseline.
2.  **Set the Gain first:** Set your phono stage to the closest match for your output voltage. Play a record with high dynamic range. If you hear distortion during loud parts, drop the gain by one step.
3.  **Adjust Resistive Loading (MC only):** Start at the manufacturer's recommendation. Listen to a track with prominent acoustic guitar or cymbals. If it sounds "metallic," lower the resistance. If it sounds "dead," increase it.
4.  **Adjust Capacitive Loading (MM only):** Set your preamp to 100pF. Listen for vocal sibilance (the "S" sounds). If the "S" sounds are piercing, you may have too much total capacitance. Try to use the shortest RCA cables possible between the turntable and the preamp.
5.  **The "Final Listen" Test:** Once you think you have it right, leave it for two days. Listen to various genres. Your ears need time to adjust to the new tonal balance before you make final judgments.
