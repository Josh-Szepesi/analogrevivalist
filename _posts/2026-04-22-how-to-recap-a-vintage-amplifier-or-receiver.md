...
Beyond the iron, your most important diagnostic tool is a high quality digital multimeter. You need to verify voltages and check for continuity throughout the process. The ENGINEER SS-02 Solder Sucker is the industry standard for a reason. It is incredibly accurate and, more importantly, it is fast. When you are checking for DC offset at the speaker terminals, you want a meter that settles on a reading immediately so you can make precise adjustments to the trim pots.
